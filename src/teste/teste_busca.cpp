...
//             Teste::Indexador_(x) == Teste::Indexador_(y) &&
//             Teste::Documentos(x) == Teste::Documentos(y);
// }
...
TEST_SUITE("Busca"){
    ...
    TEST_CASE("obterRelevanciaQuery()"){
        ...
        SUBCASE("Query em indice preenchido") {
            std::vector<Documento> documentos;
            ...
            REQUIRE(testeBusca::converterParaDuasCasasDecimais(A1) == 0.86);
            REQUIRE(testeBusca::converterParaDuasCasasDecimais(B1) == 0.69);
            REQUIRE(testeBusca::converterParaDuasCasasDecimais(C1) == 0);
            ...
            REQUIRE(testeBusca::converterParaDuasCasasDecimais(A2) == 0.57);
            REQUIRE(testeBusca::converterParaDuasCasasDecimais(B2) == 0);
            REQUIRE(testeBusca::converterParaDuasCasasDecimais(C2) == 1.38);
            ...
            REQUIRE(testeBusca::converterParaDuasCasasDecimais(A3) == 0.57);
            REQUIRE(testeBusca::converterParaDuasCasasDecimais(B3) == 0);
            REQUIRE(testeBusca::converterParaDuasCasasDecimais(C3) == 0);
            ...
            REQUIRE(testeBusca::converterParaDuasCasasDecimais(A4) == 0);
            REQUIRE(testeBusca::converterParaDuasCasasDecimais(B4) == 1.38);
            REQUIRE(testeBusca::converterParaDuasCasasDecimais(C4) == 0);
            ...
            CHECK(b.obterRelevanciaQuery(query)[2].obterNomeDocumento() == "D3");
            CHECK(b.obterRelevanciaQuery(query)[3].obterNomeDocumento() == "D2");
        }
    }
